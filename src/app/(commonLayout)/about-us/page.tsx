    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-6 lg:p-12 bg-default">
      <section className="w-full max-w-6xl text-center">
        ...
        <p className="text-lg text-default leading-relaxed">
          ...
          everything related to pet care. Whether you&apos;re looking for expert
          tips on taking care of your pets, sharing stories, or calculating
          nutrition needs, our platform provides all the tools you need to
          ensure your pets are happy and healthy.
        </p>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-default leading-relaxed">
              At Pawfect, we believe in the power of knowledge to create happier
              and healthier pets. Our mission is to provide pet owners with
              reliable, expert advice and tools that empower them to offer the
              best care for their beloved pets.
            </p>
          </div>
      ...
      <section className="w-full max-w-6xl mt-16 text-center">
        ...
        <p className="mt-4 text-default leading-relaxed">
          Become a part of our growing community of pet lovers. Whether you’re a
          new pet owner or a seasoned one, Pawfect is here to support you in
